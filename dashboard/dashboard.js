...
doc.setFontSize(18);
doc.text("SMART PATROL MANAGEMENT SYSTEM", 105, 18, { align: "center" });

doc.setFontSize(12);
doc.text("PATROL REPORT", 105, 26, { align: "center" });
...
doc.text(
    "Tanggal : " + (activeFilter.tanggal || "Semua"),
    15,
    y
);

doc.text(
    "Lokasi : " + (activeFilter.lokasi || "Semua"),
    15,
    y + 7
);

doc.text(
    "Petugas : " + (activeFilter.nama || "Semua"),
    15,
    y + 14
);
...
head:[["Executive Summary","Nilai"]],

body:[

["Total Patrol",totalPatrol],

["Petugas Aktif",totalPetugas],
...
head:[["Waktu","Petugas","Lokasi","Checkpoint","Situasi"]],
...
"Generated by Smart Patrol Management System",
...
"Security Department - PT United Tractors Tbk",
